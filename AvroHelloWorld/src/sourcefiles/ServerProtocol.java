...
public interface ServerProtocol {
  public static final org.apache.avro.Protocol PROTOCOL = org.apache.avro.Protocol.parse("{\"protocol\":\"ServerProtocol\",\"namespace\":\"sourcefiles\",\"types\":[],\"messages\":{\"enter\":{\"request\":[{\"name\":\"type\",\"type\":\"string\"},{\"name\":\"ip\",\"type\":\"string\"},{\"name\":\"port\",\"type\":\"int\"}],\"response\":\"string\"},\"leave\":{\"request\":[{\"name\":\"userName\",\"type\":\"string\"}],\"response\":\"string\"},\"getClients\":{\"request\":[],\"response\":{\"type\":\"array\",\"items\":\"string\"}},\"getLightStatuses\":{\"request\":[],\"response\":{\"type\":\"array\",\"items\":\"string\"}},\"changeLightState\":{\"request\":[{\"name\":\"lightName\",\"type\":\"string\"}],\"response\":\"string\"},\"showFridgeInventory\":{\"request\":[{\"name\":\"fridgeName\",\"type\":\"string\"}],\"response\":\"string\"},\"requestShowEmptyFridge\":{\"request\":[{\"name\":\"fridgeName\",\"type\":\"string\"}],\"response\":\"string\"},\"showCurrentHouseTemp\":{\"request\":[],\"response\":\"int\"},\"showTempHistory\":{\"request\":[],\"response\":{\"type\":\"map\",\"values\":\"int\"}},\"connectUserToFridge\":{\"request\":[{\"name\":\"fridgeName\",\"type\":\"string\"}],\"response\":\"string\"},\"showConnectedFridges\":{\"request\":[],\"response\":{\"type\":\"array\",\"items\":\"string\"}},\"updateTemperature\":{\"request\":[{\"name\":\"sensorName\",\"type\":\"string\"},{\"name\":\"sensorValue\",\"type\":\"int\"}],\"response\":\"null\"}}}");
  java.lang.CharSequence enter(java.lang.CharSequence type, java.lang.CharSequence ip, int port) throws org.apache.avro.AvroRemoteException;
  ...
  public interface Callback extends ServerProtocol {
    ...
    void enter(java.lang.CharSequence type, java.lang.CharSequence ip, int port, org.apache.avro.ipc.Callback<java.lang.CharSequence> callback) throws java.io.IOException;
