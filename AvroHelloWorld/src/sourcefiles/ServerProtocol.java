...
public interface ServerProtocol {
  public static final org.apache.avro.Protocol PROTOCOL = org.apache.avro.Protocol.parse("{\"protocol\":\"ServerProtocol\",\"namespace\":\"sourcefiles\",\"types\":[{\"type\":\"record\",\"name\":\"TemperatureRecord\",\"fields\":[{\"name\":\"time\",\"type\":\"string\"},{\"name\":\"temperature\",\"type\":\"double\"}]},{\"type\":\"record\",\"name\":\"TemperatureAggregate\",\"fields\":[{\"name\":\"counter\",\"type\":\"int\"},{\"name\":\"record\",\"type\":\"TemperatureRecord\"}]},{\"type\":\"record\",\"name\":\"ReplicationData\",\"fields\":[{\"name\":\"connectedUsers\",\"type\":{\"type\":\"map\",\"values\":\"string\"}},{\"name\":\"connectedLights\",\"type\":{\"type\":\"map\",\"values\":\"string\"}},{\"name\":\"connectedFridges\",\"type\":{\"type\":\"map\",\"values\":\"string\"}},{\"name\":\"connectedTS\",\"type\":{\"type\":\"map\",\"values\":\"string\"}},{\"name\":\"temperatures\",\"type\":{\"type\":\"array\",\"items\":\"TemperatureAggregate\"}},{\"name\":\"userlocation\",\"type\":{\"type\":\"map\",\"values\":\"boolean\"}},{\"name\":\"firstNeighbour\",\"type\":{\"type\":\"array\",\"items\":\"string\"}},{\"name\":\"lastNeighbour\",\"type\":{\"type\":\"array\",\"items\":\"string\"}},{\"name\":\"idCounter\",\"type\":\"int\"}]}],\"messages\":{\"enter\":{\"request\":[{\"name\":\"type\",\"type\":\"string\"},{\"name\":\"ip\",\"type\":\"string\"}],\"response\":\"string\"},\"leave\":{\"request\":[{\"name\":\"userName\",\"type\":\"string\"}],\"response\":\"string\"},\"enterHouse\":{\"request\":[{\"name\":\"userName\",\"type\":\"string\"}],\"response\":\"boolean\"},\"leaveHouse\":{\"request\":[{\"name\":\"userName\",\"type\":\"string\"}],\"response\":\"boolean\"},\"getClients\":{\"request\":[],\"response\":{\"type\":\"array\",\"items\":\"string\"}},\"getLightStatuses\":{\"request\":[],\"response\":{\"type\":\"array\",\"items\":\"string\"}},\"changeLightState\":{\"request\":[{\"name\":\"lightName\",\"type\":\"string\"}],\"response\":\"string\"},\"getFridgeInventory\":{\"request\":[{\"name\":\"fridgeName\",\"type\":\"string\"}],\"response\":{\"type\":\"array\",\"items\":\"string\"}},\"requestShowEmptyFridge\":{\"request\":[{\"name\":\"fridgeName\",\"type\":\"string\"}],\"response\":\"string\"},\"showCurrentHouseTemp\":{\"request\":[],\"response\":\"int\"},\"showTempHistory\":{\"request\":[],\"response\":{\"type\":\"map\",\"values\":\"int\"}},\"connectUserToFridge\":{\"request\":[{\"name\":\"fridgeName\",\"type\":\"string\"}],\"response\":\"string\"},\"showConnectedFridges\":{\"request\":[],\"response\":{\"type\":\"array\",\"items\":\"string\"}},\"updateTemperature\":{\"request\":[{\"name\":\"sensorName\",\"type\":\"string\"},{\"name\":\"TemperatureRecord\",\"type\":\"TemperatureRecord\"}],\"response\":\"null\"},\"notifyUsersOfEmptyFridge\":{\"request\":[{\"name\":\"fridgeName\",\"type\":\"string\"}],\"response\":\"string\"},\"showHeartbeat\":{\"request\":[{\"name\":\"userName\",\"type\":\"string\"}],\"response\":\"null\"},\"getReplication\":{\"request\":[],\"response\":\"ReplicationData\"},\"requestFridgeAddress\":{\"request\":[{\"name\":\"fridgeName\",\"type\":\"string\"},{\"name\":\"clientIp\",\"type\":\"string\"}],\"response\":\"string\"},\"closeFridge\":{\"request\":[{\"name\":\"fridgeName\",\"type\":\"string\"},{\"name\":\"clientIp\",\"type\":\"string\"}],\"response\":\"null\"},\"closeServer\":{\"request\":[],\"response\":\"boolean\"}}}");
  ...
  sourcefiles.ReplicationData getReplication() throws org.apache.avro.AvroRemoteException;
  java.lang.CharSequence requestFridgeAddress(java.lang.CharSequence fridgeName, java.lang.CharSequence clientIp) throws org.apache.avro.AvroRemoteException;
  java.lang.Void closeFridge(java.lang.CharSequence fridgeName, java.lang.CharSequence clientIp) throws org.apache.avro.AvroRemoteException;
  boolean closeServer() throws org.apache.avro.AvroRemoteException;
  ...
  public interface Callback extends ServerProtocol {
    ...
    void getReplication(org.apache.avro.ipc.Callback<sourcefiles.ReplicationData> callback) throws java.io.IOException;
    void requestFridgeAddress(java.lang.CharSequence fridgeName, java.lang.CharSequence clientIp, org.apache.avro.ipc.Callback<java.lang.CharSequence> callback) throws java.io.IOException;
    void closeFridge(java.lang.CharSequence fridgeName, java.lang.CharSequence clientIp, org.apache.avro.ipc.Callback<java.lang.Void> callback) throws java.io.IOException;
    void closeServer(org.apache.avro.ipc.Callback<java.lang.Boolean> callback) throws java.io.IOException;
  }
}